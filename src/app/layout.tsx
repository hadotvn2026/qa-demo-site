...
export const metadata: Metadata = {
  title: "TVNAutomationLab — Modern QA Practice Playground",
  description: "A premium, high-fidelity practice site for Selenium and Playwright automation engineers.",
};
